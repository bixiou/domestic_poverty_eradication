...
The income floors after unbalanced growth are close to the ones after the corresponding balanced growth scenario. On average, the former are 2\% larger than the latter, and they are within one-tenth (resp. one-third) of the difference with the latter in 60\% (resp. 92\%) of countries. % The resulting income floors are close to the ones in the corresponding balanced growth scenario. The income floors after unbalanced growth are on average 2\% greater than the ones after balanced growth. Moreover, the former are within one-tenth (resp. one-third) of difference with the latter in 60\% (resp. 92\%) of countries. 
