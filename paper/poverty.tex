...
BCL found that 62 countries could not eradicate severe poverty (defined at the \$$_\text{2005}$2/day) with an antipoverty cap at \$$_\text{2005}$13/day, while 27 could not even with a cap at \$$_\text{2005}$2/day. 
Their findings cannot be reproduced with the revised PIP data, as the switch to 2017 PPPs (from 2005) has altered not only the level but also the distribution of incomes (for the same reason, the results of BCL and Ravallion cannot be compared). 
When I replicate the computations of BCL with their survey years but after scaling the original thresholds into 2017 PPPs by a factor $2.15/1.25 = 1.72$, I find that 101 (resp. 85) 
countries could not eradicate severe poverty with a cap at \$22.36/day (resp. \$3.44/day). 
In other words, the revision of PIP data results in an apparent impoverishment. %reduction in the capacity for domestic poverty alleviation. 
Looking ahead, in our baseline scenario with 3\% growth, we find that in 2030, 84 (resp. 59) 
