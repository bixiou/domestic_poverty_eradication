...
In other words, the revision of PIP data resulted in an apparent enrichment. % TODO: check
...
so even if it replicates the Chinese miracle, which is not easy given its institutional capacity, the D.R.C. will not be able to eradicate extreme poverty on its own before 2055. % Not to mention that the Chinese miracle relied on strong institutional capacity, which is often lacking in low-income countries. 
