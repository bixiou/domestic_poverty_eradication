...
The percentiles of each country's post-tax income (or consumption) in purchasing power parity (PPP) are estimated from household surveys by the Poverty and Inequality Platform (PIP) of the World Bank (ex-PovcalNet) and given in constant 2017 \$.
