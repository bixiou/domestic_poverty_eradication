...
While addressing the feasibility of global redistribution remains outside the scope of this paper, I added the following sentences acknowledging the challenges it represents. % TODO complete and reproduce for R2's last point
~\\ ~\\
...
response TODO add income floor
~\\ ~\\
